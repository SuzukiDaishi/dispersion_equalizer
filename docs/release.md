...
7. Confirm the GitHub Release has these assets:
   ...
   ```text
   Dispersion.Equalizer-v0.1.10-windows-x64.zip
   Dispersion.Equalizer-v0.1.10-linux-x64.zip
   Dispersion.Equalizer-v0.1.10-macos-universal.dmg
   ```
...
- Tags must use the `v*` format, e.g. `v0.1.10`.
